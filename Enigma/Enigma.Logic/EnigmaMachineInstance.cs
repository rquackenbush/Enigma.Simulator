namespace Enigma.Logic
{
    public class EnigmaMachineInstance
    {
        ...
        public EnigmaMachineInstance(EnigmaMachine machine, EnigmaInput input, EnigmaRotor[] rotors, EnigmaReflector reflector, int[] initialRotorIndicies)
        {
        ...
        public EnigmaInput Input { get; }

        public EnigmaRotor[] Rotors { get; }

        public EnigmaReflector Reflector { get;  }
